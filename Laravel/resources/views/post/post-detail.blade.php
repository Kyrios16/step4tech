...
<div class="detail-container">
  ...
  <div class="detail-body">
    ...
    <form class="feedback-txtfield" method="POST" action="{{ route('feedback.post',$post->id) }}" enctype="multipart/form-data">
      ...
      <textarea name="content" onkeyup="autoheight(this)" rows="1" class="input-feedback-content @error('content') is-invalid @enderror" id="feedback-content" placeholder="Enter Your Feedback..."></textarea>
